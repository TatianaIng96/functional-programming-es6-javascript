...
const ferraris = cars.filter(function(element){
    return element.brand === 'Ferrari';
})
//console.log(ferraris);


const nineties = cars.filter(function(element){
    return element.model >= 1980 && element.model<= 1990;
    
})

//console.log(nineties);

const list = cars.map(function(element){
